...
CCGIFEncoder.prototype.save = function( callback ) {
  ...
  function CCapture (settings) {
    ...
    var _performanceTime

    var _performanceStartTime
    ...
    var _oldRequestAnimationFrame = window.requestAnimationFrame

    var _oldNow = window.Date.now

    var _oldPerformanceNow = window.performance.now

    var _oldGetTime = window.Date.prototype.getTime
